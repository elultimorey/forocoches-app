...
import akiniyaloctsImgur.helpers.DocumentHelper;
import akiniyaloctsImgur.helpers.IntentHelper;
...
import akiniyaloctsImgur.services.OnImageUploadedListener;
import akiniyaloctsImgur.services.UploadService;
import akiniyaloctsImgur.utils.aLog;


public class ForoCochesActivity extends Activity implements OnImageUploadedListener {
    ...
    // ImageUpload
    public final static String TAG = ForoCochesActivity.class.getSimpleName();
    ...
    public void onResume() {
        ...
        if(android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.HONEYCOMB){
            webView.onResume(); // Normal onResume for versions greater than or equal to API 11
        }
    ...
    public void onPause(){
        ...
        if(webView != null) {
            if(android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.HONEYCOMB){
                webView.onPause(); // Normal onPause for versions greater than or equal to API 11
            }
            webView.pauseTimers(); // This does the same thing as onPause but does it for all the WebViews, it works on all API levels
        }
    ...
    public void openImageUpload() {
        ...
        uploadImage = (ImageView) dialog.findViewById(R.id.upload_image);
        Button chooseBtn = (Button) dialog.findViewById(R.id.choose_btn);
        chooseBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                IntentHelper.chooseFileIntent(mActivity);
            }
        });
        uploadBtn = (Button) dialog.findViewById(R.id.upload_btn);
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if (verificaConexion(mContext)) {
                    createUpload(chosenFile);

                    new UploadService(upload, mActivity).execute();
                }
                else
        ...
        Button cancelUpld = (Button) dialog.findViewById(R.id.back_btn);
        cancelUpld.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dialog.dismiss();
            }
